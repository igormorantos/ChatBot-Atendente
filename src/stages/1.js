...
export const stageOne = {
  async exec(params) {
    ...
    const isMsgValid = /[1|2|3|4]/.test(message)
...
const options = {
  1: () => {
    let message = 'Vou te enviar um PDF com as informações de valores, formas de pagamento e agendamento e qualquer dúvida estou a disposição'
